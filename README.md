...
A web application for managing categories, products, users, and orders of Computer parts and components. This project demonstrates a full-stack PHP application with a MySQL database.
